...
<script>\
    document.addEventListener("DOMContentLoaded", function(){\
        ...
        if(memberEmail == null || memberEmail == "") {\
            ...
            document.getElementById("myFavoritesLink").setAttribute("style", "display:none");\
        }\
        else {\
            ...
            document.getElementById("myFavoritesLink").setAttribute("style", "display:block");\
        }\
        ...
        <div id="menuLoggedOut" style="display: none;">\
            <nav>\
                <ul class="nav nav-pills nav-top">\
                    ...
                    <li>\
                        <a href="/B/' + countryPrefix + '/services.html"><i class="fas fa-cogs"></i>Services</a>\
                    </li>\
                    <li>\
        ...
        <div class="container">\
            <nav class="nav-main mega-menu">\
                <ul class="nav nav-pills nav-main" id="mainMenu">\
                    <li ><a id="myFavoritesLink" href="/B/' + countryPrefix + '/myFavorites.html"><i class="icon icon-bookmark"></i> My Favorites</a></li>\
                    <li>\
